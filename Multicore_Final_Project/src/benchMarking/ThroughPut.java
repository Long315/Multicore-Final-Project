...
public class ThroughPut {
    ...
    public int alternateFixedThreads(int numThreads, Class<? extends ParallelPriorityQueue> queueClass, int c) {
        ...
        for (int loop = 0; loop < loopCount; loop++) {
            try {
                ...
                // let all threads running
                for (Alternate alternate : alternates) alternate.start();
    ...
    public static void main(String args[]) {
        ...
        //		tp.producerConsumerDiffProducerPortion(SkipQueue.class, 0);
        tp.alternateDiffNumThreads(MultiQueue.class, 3);
    }
}
